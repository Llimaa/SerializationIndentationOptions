...
Console.WriteLine("Digite 1 para identar seu código em Tabs");
Console.WriteLine("Digite 2 para identar seu código em espaços");
Console.WriteLine("Digite 3 para identar seu código com o Default web options");
...
if(key != "3") {
    Console.WriteLine($"Agora informe a quantidade de espaçamento que você deseja { type }");
